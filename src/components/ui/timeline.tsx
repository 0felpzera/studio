  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-5xl mb-4 font-bold text-foreground max-w-4xl text-center mx-auto">
          Ferramentas para o seu Sucesso
        </h2>
        <p className="text-muted-foreground text-base md:text-lg max-w-2xl text-center mx-auto">
          Explore como cada recurso da Trendify pode impulsionar seu conteúdo e
          acelerar seu crescimento nas redes sociais.
        </p>
      </div>
