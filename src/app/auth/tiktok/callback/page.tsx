        ...
        if (state === '___UNIQUE_STATE_TOKEN_TIKTOK___') {
          ...
          try {
            ...
            await setDoc(newTiktokAccountRef, {
              ...
              userId: user.uid,
              followerCount: 0, // Placeholder - Real data requires backend token exchange
              engagementRate: 0, // Placeholder - Real data requires backend token exchange
            });

            setStatusMessage("Conta TikTok Conectada com sucesso! Redirecionando...");
            toast({
              title: "Conta TikTok Conectada!",
              description: "Sua conta foi vinculada. A busca de dados reais requer configuração de backend.",
            });
